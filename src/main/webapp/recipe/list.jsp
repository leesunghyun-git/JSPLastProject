...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           	<%-- 검색 --%>
                           	<li><h4>총 <span style="color:green;font-size:50px;">${count }</span>개의 맛있는 레시피가 있습니다.</h4></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="archive-area section_padding_80">
        <div class="container">
			...
			<%-- no,hit,title,poster,chef,link,likecount,replycount,num --%>				
                <!-- Single Post -->
                            ...
                            <div class="post-meta d-flex">
                                ...
                                <div class="post-comment-share-area d-flex">
                                    ...
                                    <div class="post-favourite">
                                        <a href="${vo.link }"><i class="fa fa-heart-o" aria-hidden="true"></i> ${vo.likecount }</a>
                                    </div>
                                    <!-- Post Comments -->
                    ...
                    <div class="pagination-area d-sm-flex mt-15">
                        <nav aria-label="#">
                            <ul class="pagination">
                            	...
                            	<li class="page-item">
                                    <a class="page-link" href="../recipe/list.do?page=${startPage-1 }"><i class="fa fa-angle-double-left" aria-hidden="true"> Before</i></a>
                                </li>
                                </c:if>
                                <c:forEach var="i" begin="${startPage }" end="${endPage }">
                                <li class="page-item ${i==curPage?'active':'' }"><a class="page-link" href="../recipe/list.do?page=${i }">${i }
                                <c:if test="${i==curPage}">
