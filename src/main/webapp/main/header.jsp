                    ...
                    <div class="signup-search-area d-flex align-items-center justify-content-end">
                         ...
                         <c:if test="${sessionScope.id==null }">
                            <div class="login">
                                ...
                                <input type="submit" value="login" class="btn-sm btn-danger" id="logBtn">
                            </div>
                         </c:if>
                         <c:if test="${sessionScope.id!=null }">
                            <div class="login">
                                <form action="../member/logout.do" method="post">
                                ${sessionScope.name }(${sessionScope.admin=='y'?'관리자':'일반사용자' })님 로그인 하셨습니다.
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="yummyfood-nav">
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        <a class="dropdown-item" href="../food/list.do">맛집 찾기</a>
                                        <%-- 지도 이용 --%>
                                ...
                                <c:if test="${sessionScope.id!=null && sessionScope.admin=='n'}">
                                <li class="nav-item">
                                    <a class="nav-link" href="../chat/chat.do">실시간 채팅</a>
                                </li>
                                </c:if>
                                <c:if test="${sessionScope.id!=null && sessionScope.admin=='n'}">
                                <li class="nav-item">
                                    <a class="nav-link" href="../mypage/mypage_main.do">마이 페이지</a>
                                </li>
                                </c:if>
