        ...
        <div class="container">
            <div class="row goods_row">
            	<table class="table">
            		...
            		<tr>
            			<td width="70%">
            				<img src="https://recipe1.ezmember.co.kr/img/mobile/icon_delivery3.png" width="20px" height="20px">
            		...
            		<tr>
            			<td width="70%">
            				<img src="https://recipe1.ezmember.co.kr/img/mobile/icon_point.png" width="20px" height="20px">
            				<c:forEach var="i" begin="1" end="7">
            					&nbsp;
            				</c:forEach>
